...
| :--- | :--- | :--- |
| 📱 **Çalışan Uygulama (APK)** | Uygulamanın test edilebilir Android kurulum dosyası. | **[Uygulamayı İndir (Google Drive)](https://drive.google.com/file/d/1JZzcaUiCDCcPjSWGVRaWHFmqZv_AJLfv/view?usp=sharing)** |
| 📋 **Test Kullanıcı Rehberi** | Uygulamanın nasıl indirileceğini ve test edileceğini anlatan rehber. | **[Test Rehberini Oku ](TEST_REHBERI.md)** |
