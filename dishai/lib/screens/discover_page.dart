...
class _DiscoverPageState extends State<DiscoverPage> {
  ...
  Widget _buildMapView() {
    ...
    final Map<String, Offset> cityCoordinates = {
      ...
      'Bursa': const Offset(0.17, 0.35), 'Hatay': const Offset(0.55, 0.95), 'Mersin': const Offset(0.41, 0.94), 'Erzurum': const Offset(0.82, 0.38),
      'Kayseri': const Offset(0.52, 0.59), 'Şanlıurfa': const Offset(0.69, 0.83)
    };
  ...
  Widget _buildUserMessage(UserTextMessage message) {
    return Align(
      ...
      child: Container(
        ...
        margin: const EdgeInsets.symmetric(vertical: 4).copyWith(left: 80),
